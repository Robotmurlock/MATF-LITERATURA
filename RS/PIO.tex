...
\section{Koja je uloga i šta su osnovni elementi dijagrama klasa?}
  ...
  Ukoliko se veza između objekta može ostvariti na više načina, onda je to
  ...
  \begin{itemize}
    \item \textbf{Ime odnosa:} Kratko objašnjena uloga veze objekata.
...
\section{Navesti dijagrame ponašanja UML-a.}
  ...
  \end{enumerate}
    ...
    Dijagrami ponašanja se bave dinamičkom prirodom softverskog sitema. Oni
...
\section{Objasniti pretpostavku agilnog razvoja da su pojedinci i saradnja ispred procesa i alata.}
  ...
  da tim uspešno odgovori na promene ili ispošte zahtev klijenta. \\
  \indent Komunikacija
...
\end{lstlisting}
  ...
  izbaci \textit{(throw)} izuzetak \textit{(exception)} kao posledica greške, nije uvek moguće uhvatiti \textit{(catch)} tj. 
