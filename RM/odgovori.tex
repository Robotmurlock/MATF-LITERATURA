...
Ova skripta predstavlja kombinovan materijal sa slajdova profesora Kartelja i knjige Tanenbauma 
tj. više je opširna od slajdova, a manje od knjige. Preporučio bih kolegama da svakako pročitaju
knjigu ili odgledaju video prezentacije profesora Tanenbauma. 
...
\section{Protokoli i slojevi}
    \noindent \textbf{Šta sve treba mreža da radi za korisnike?}
    \begin{itemize}
...
\section{MAC protokoli zasnovani na redosledu: ,,Token Ring``}
    ...
    sa slučajnošću se obično teško nadmašuju (jednostavni i dovoljno dobri, skalabilni). 
...
\section{Hijearhijsko nasleđivanje}
...
\section{Protokoli kliznih prozora}
    ...
    nužno imati te mehanizme na nižim nivoima. U ekstremnom slučaju bi moglo sve da radi
